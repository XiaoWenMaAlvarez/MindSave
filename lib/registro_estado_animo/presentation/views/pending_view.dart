...
class _PendingViewBody extends ConsumerStatefulWidget {
  const _PendingViewBody();

  @override
  ConsumerState<_PendingViewBody> createState() => _PendingViewBodyState();
}

class _PendingViewBodyState extends ConsumerState<_PendingViewBody> {
        ...
        child: Column(
          ...
          children: [
            ...
            Padding(
              ...
              child: Text("No se encontraron registros de estado de ánimo pendientes", style: textStyle, textAlign: TextAlign.center,),
            )
          ],
        ),
      );
  ...
  Widget build(BuildContext context) {
    ...
    return Padding(
      ...
      child: Column(
        ...
        children: [
          Text('Registro de Estado de Ánimo Pendientes', style: titleStyle),
          const SizedBox(height: 10),
          Text('Seleccione uno de los registros de estado de ánimo pendientes para completarlo.',
            style: bodyStyle),
    ...
    return Column(
      children: [
        ...
        ListTile(
          ...
          onTap: () => context.push("/registroEstadoAnimo/3/${listaRegistroEstadoAnimoPendientes[i].id}"),
        )
      ],
    );
  }
